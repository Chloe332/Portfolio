...
export const ContainerScroll = ({
  ...
  // Finish the tilt-to-flat reveal by 40% scroll progress instead of 100%,
  // so the card flattens out sooner rather than staying tilted for the
  // whole scroll through the section.
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="h-full w-full overflow-y-auto rounded-2xl bg-gray-100 dark:bg-zinc-900 md:rounded-2xl md:p-4">
        {children}
      </div>
    </motion.div>
  );
